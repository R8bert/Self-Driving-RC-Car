...
class CarGUI:
    ...
    def CreateBackground(self):
        ...
        file=("/home/pi/Desktop/SyncMSI/gui_car/build/assets/frame0/button_3_on.png"))
        self.button_2 = Button(
        image=self.button_image_2,
        borderwidth=0,
        highlightthickness=0,
        command=lambda: threading.Thread(target=self.TurnSoundOn, args=()).start(),
        relief="flat"
        )
        self.button_2.place(
        x=724.0,
    ...
    def TurnSoundOn(self):
        ...
        if self.soundOn == False:
            ...
            self.soundOn = False
            print("Parking sound OFF")
            # Create the buttons
            self.button_image_2 = PhotoImage(
                file=("/home/pi/Desktop/SyncMSI/gui_car/build/assets/frame0/button_3_off.png"))
            self.button_2 = Button(
                image=self.button_image_2,
                borderwidth=0,
                highlightthickness=0,
...
#                 self.image_image_3.destroy()
    ...
    def YellowBeep(self):
        ...
        if self.soundOn == True and self.yellow == True:
            print("yellow beep")
            while True:
    ...
    def RedBeep(self):
        ...
        if self.soundOn == True and self.red == True:
            print("red beep")
            while True:
                GPIO.output(self.buzzerPin, GPIO.HIGH)
                time.sleep(0.45)
    ...
    def CheckColor(self):
        while True:
            if self.red == True:
                ...
                threading.Thread(target=self.RedBeep, args=()).start()
                ...
                threading.Thread(target=self.YellowBeep, args=()).start()
...
class CarControl:
    ...
    def __init__(self):
        print("CarControl Interface 1.3b - Initialization")
        self.ledR = LED(27)
        self.ledL = LED(22)
